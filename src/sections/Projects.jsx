...
export default function Projects() {
  ...
  const projectsInfo = [
    ...
    {
      name: 'Product List with Cart (Netlify)',
      description:
        'E-commerce style product list with cart, deployed on Netlify.',
      tech: ['React', 'CSS'],
      github: 'https://github.com/irinaboj/product-list-cart',
      live: 'https://product-list-cart.netlify.app',
      image: '../../public/Screenshot 2025-08-01 060815.png',
    },
  ];
  ...
  return (
    <section
      id="projects"
      className="relative z-10 min-h-screen w-full bg-black/80 md:py-10 md:px-4 "
    >
